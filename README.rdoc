...
Data resurrection heavily uses this amazing gem internally, but currently it doesn't support encoding conversion, type conversion and does not handles fields whose name equals to SQL reserved words and Ruby methods.
